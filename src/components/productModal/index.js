        ...
        <Dialog open={true} className='productModal' onClose={() => context.setIsOpenProductModal(false)}>
            ...
            <div className='d-flex align-items-center'>
                <div className='d-flex align-items-center mr-4'>
                    ...
                    <Rating name='read-only' className='ml-2' value={5} readOnly size='small' precision={0.5} />
                </div>
                <hr />
                <br />
                <br />
                ...
                <div className='col-md-5'>
                    <div className='productZoom position-relative'>
                        ...
                        <Slider {...settings2} className='zoomSliderBig' ref={zoomSliderBig}>
                            <div className='item'>
                                <InnerImageZoom zoomType="hover" zoomScale={2} src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-62-346x310.jpg" />
                            </div>
                            <div className='item'>
                                <InnerImageZoom zoomType="hover" zoomScale={2} src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image2-47.jpg" />
                            </div>
                            <div className='item'>
                                <InnerImageZoom zoomType="hover" zoomScale={2} src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image3-35.jpg" />
                            </div>
                        </Slider>
                    </div>
                    <Slider {...settings} className='zoomSlider' ref={zoomSlider}>
                        <img className='w-100' src='https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-62.jpg' alt='' onClick={() => goto(0)} />
                        <img className='w-100' src='https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image2-47.jpg' alt='' onClick={() => goto(1)} />
                        <img className='w-100' src='https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image3-35.jpg' alt='' onClick={() => goto(2)} />
                    </Slider>
                </div>
                <div className='col-md-7'>
                    ...
                    <div className="productSize d-flex align-items-center">
                        ...
                        <ul className="list list-inline mb-0 pl-4 false">
                            <li className="list-inline-item"><a className="tag " href='/'>Xs</a></li>
                            <li className="list-inline-item"><a className="tag " href='/'>S</a></li>
                            <li className="list-inline-item"><a className="tag " href='/'>xl</a></li>
                            <li className="list-inline-item"><a className="tag " href='/'>XS</a></li>
                        </ul>
                    </div>
                    ...
                    <div className='d-flex align-items-center mt-5 actions'>
                        <Button className='btn-round btn-sml'>
                            <IoIosHeartEmpty className='text-danger' /> &nbsp; ADDED TO WISHLIST
                        </Button>
